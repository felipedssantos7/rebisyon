// Selected field.
var selectedField = "front-input";
$("#front-input").click(function() {
    selectedField = "front-input";
});

$("#back-input").click(function() {
    selectedField = "back-input";
});
...
function addImage(event) {
    ...
    reader.onload = function () {
        ...
        // if (id == "front-card" || id == "back-card") {
            var parent = document.getElementById(selectedField);
